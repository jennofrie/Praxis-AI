...
DROP POLICY IF EXISTS "Users can manage own ndis_plans" ON ndis_plans;
...
-- Session Goal Notes
DROP POLICY IF EXISTS "Users can manage own session_goal_notes" ON session_goal_notes;
...
DROP POLICY IF EXISTS "Users can manage own assistive_technology" ON assistive_technology;
...
DROP POLICY IF EXISTS "Service role can insert ai_usage" ON ai_usage;
